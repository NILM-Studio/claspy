...
def process_file(file_path, target_dir, threshold):
    ...
    if best_score > threshold:
        ...
        # print(f"  Processing: Score > {threshold:.2f}. Min cluster: {min_mean_label} (mean={min_mean_val:.2f})")
...
if __name__ == "__main__":
    # Default behavior
    SOURCE_DIR = r'./scripts/washing_machine'
    TARGET_DIR = r'./scripts/washing_machine_cluster'
